...
data class VideoState(
    ...
    val analysisLatestCaptureRequestTimestampNanos: Long? = null,
    val analysisLatestPixelCopyCompletedTimestampNanos: Long? = null,
    val analysisPendingFrameDepth: Int = 0,
    ...
    val processedRenderedFrameTimestampNanos: Long? = null,
    val processedCaptureRequestTimestampNanos: Long? = null,
    val processedPixelCopyCompletedTimestampNanos: Long? = null,
    val processedDetectorInferenceStartedTimestampNanos: Long? = null,
    val processedDetectorInferenceCompletedTimestampNanos: Long? = null,
